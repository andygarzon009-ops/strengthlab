...
export const DEFAULT_EXERCISES: DefaultExercise[] = [
  ...
  { name: "Smith Machine Front Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Smith Machine Bulgarian Split Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Smith Machine Reverse Lunge", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Smith Machine Romanian Deadlift", muscleGroup: "Hamstrings", splits: "PULL,LEGS,LOWER" },
  { name: "Smith Machine Good Morning", muscleGroup: "Hamstrings", splits: "LEGS,LOWER" },
  { name: "Smith Machine Glute Bridge", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Smith Machine Sumo Squat", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Smith Machine Calf Raise", muscleGroup: "Calves", splits: "LEGS,LOWER" },

  // Plate-loaded machines (legs) — Leg Press / Single-Leg Press / Hack Squat / Pendulum Squat
  // live in the Quads section above.
  { name: "Reverse Hack Squat", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Belt Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "V-Squat Machine", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Hip Thrust Machine", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Plate-Loaded Glute Kickback", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Plate-Loaded Abductor", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Plate-Loaded Adductor", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Plate-Loaded Leg Extension", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Plate-Loaded Lying Leg Curl", muscleGroup: "Hamstrings", splits: "LEGS,LOWER" },
  { name: "Plate-Loaded Seated Leg Curl", muscleGroup: "Hamstrings", splits: "LEGS,LOWER" },
  { name: "Plate-Loaded Standing Calf Raise", muscleGroup: "Calves", splits: "LEGS,LOWER" },
  { name: "Plate-Loaded Seated Calf Raise", muscleGroup: "Calves", splits: "LEGS,LOWER" },
  ...
  // Calisthenics — legs
  { name: "Bodyweight Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Jump Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Split Squat (Bodyweight)", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Bulgarian Split Squat (Bodyweight)", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Shrimp Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Skater Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Nordic Curl Negative", muscleGroup: "Hamstrings", splits: "LEGS,LOWER" },
  { name: "Single-Leg Glute Bridge", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Step-Up (Bodyweight)", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Walking Lunge (Bodyweight)", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Broad Jump", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Box Jump", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Calf Raise (Bodyweight)", muscleGroup: "Calves", splits: "LEGS,LOWER" },
  { name: "Single-Leg Calf Raise (Bodyweight)", muscleGroup: "Calves", splits: "LEGS,LOWER" },
  ...
  // EZ-Bar variants
  { name: "EZ-Bar Skullcrusher", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar Preacher Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Spider Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Supinated Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Pronated Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Reverse Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Drag Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Wide-Grip Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Narrow-Grip Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Zottman Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Cable Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Close-Grip Bench Press", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar Lying Tricep Extension", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar Overhead Tricep Extension", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar Seated Tricep Extension", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar Standing Tricep Extension", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar Behind-the-Head Tricep Extension", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar French Press", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar JM Press", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "EZ-Bar Pullover", muscleGroup: "Back", splits: "PULL,UPPER" },
  { name: "EZ-Bar Upright Row", muscleGroup: "Shoulders", splits: "PULL,UPPER" },
  { name: "EZ-Bar Bent-Over Row", muscleGroup: "Back", splits: "PULL,UPPER" },
  { name: "EZ-Bar Front Raise", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "EZ-Bar Wrist Curl", muscleGroup: "Forearms", splits: "ARMS,UPPER,PULL" },
  { name: "EZ-Bar Reverse Wrist Curl", muscleGroup: "Forearms", splits: "ARMS,UPPER,PULL" },
  { name: "EZ-Bar Good Morning", muscleGroup: "Hamstrings", splits: "PULL,LOWER" },
  { name: "EZ-Bar Romanian Deadlift", muscleGroup: "Hamstrings", splits: "PULL,LOWER" },
  { name: "EZ-Bar 21s", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Concentration Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar Incline Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "EZ-Bar High Pull", muscleGroup: "Back", splits: "PULL,UPPER" },

  // Olympic / power lifts
  { name: "Power Clean", muscleGroup: "Back", splits: "PULL,FULL_BODY" },
  { name: "Hang Clean", muscleGroup: "Back", splits: "PULL,FULL_BODY" },
  { name: "Hang Power Clean", muscleGroup: "Back", splits: "PULL,FULL_BODY" },
  { name: "Clean & Jerk", muscleGroup: "Shoulders", splits: "PUSH,FULL_BODY" },
  { name: "Power Snatch", muscleGroup: "Shoulders", splits: "PULL,FULL_BODY" },
  { name: "Hang Snatch", muscleGroup: "Shoulders", splits: "PULL,FULL_BODY" },
  { name: "Snatch (Full)", muscleGroup: "Shoulders", splits: "PULL,FULL_BODY" },
  { name: "Muscle Snatch", muscleGroup: "Shoulders", splits: "PULL,FULL_BODY" },
  { name: "Push Jerk", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "Split Jerk", muscleGroup: "Shoulders", splits: "PUSH,FULL_BODY" },
  { name: "High Pull", muscleGroup: "Back", splits: "PULL,UPPER" },
  { name: "Clean Pull", muscleGroup: "Back", splits: "PULL,LOWER" },
  { name: "Snatch Pull", muscleGroup: "Back", splits: "PULL,LOWER" },
  { name: "Overhead Squat", muscleGroup: "Quads", splits: "LEGS,FULL_BODY" },
  { name: "Power Shrug", muscleGroup: "Back", splits: "PULL,UPPER" },

  // Cable additions
  { name: "Cable Hammer Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "Cable Reverse Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "Cable Tricep Kickback", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "Cable Pullover", muscleGroup: "Back", splits: "PULL,UPPER" },
  { name: "Single-Arm Cable Row", muscleGroup: "Back", splits: "PULL,UPPER" },
  { name: "Single-Arm Cable Lateral Raise", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "Cable Shrug", muscleGroup: "Back", splits: "PULL,UPPER" },
  { name: "Cable Reverse Crunch", muscleGroup: "Core", splits: "CORE" },
  { name: "Cable Hip Abduction", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Cable Hip Adduction", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Cable Reverse Fly (Single Arm)", muscleGroup: "Shoulders", splits: "PULL,UPPER" },
  { name: "Cable Hammer Pulldown", muscleGroup: "Back", splits: "PULL,UPPER" },
  { name: "Behind-the-Back Cable Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },
  { name: "Cable Crunch (Standing)", muscleGroup: "Core", splits: "CORE" },

  // Dumbbell additions
  { name: "Dumbbell Snatch", muscleGroup: "Shoulders", splits: "PULL,FULL_BODY" },
  { name: "Dumbbell Push Press", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "Dumbbell Floor Press", muscleGroup: "Chest", splits: "PUSH,UPPER" },
  { name: "Dumbbell Crush Press", muscleGroup: "Chest", splits: "PUSH,UPPER" },
  { name: "Dumbbell Y-Raise", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "Dumbbell W-Raise", muscleGroup: "Shoulders", splits: "PULL,UPPER" },
  { name: "Dumbbell T-Raise", muscleGroup: "Shoulders", splits: "PULL,UPPER" },
  { name: "Dumbbell Lying Tricep Extension", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "Dumbbell Hip Thrust", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Dumbbell Sumo Squat", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Dumbbell Lateral Lunge", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Dumbbell Curtsy Lunge", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Renegade Row", muscleGroup: "Back", splits: "PULL,FULL_BODY" },
  { name: "Dumbbell Cuban Press", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "Dumbbell Scott Press", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "Dumbbell Tate Press", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "Dumbbell Around-the-World", muscleGroup: "Chest", splits: "PUSH,UPPER" },
  { name: "Dumbbell Z Press", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "Cross-Body Hammer Curl", muscleGroup: "Biceps", splits: "PULL,UPPER,ARMS" },

  // Triceps standalones
  { name: "JM Press", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "Tate Press", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },
  { name: "Cross-Body Tricep Extension", muscleGroup: "Triceps", splits: "PUSH,UPPER,ARMS" },

  // Kettlebell additions
  { name: "Kettlebell Goblet Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Kettlebell Front Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Kettlebell Halo", muscleGroup: "Shoulders", splits: "FULL_BODY" },
  { name: "Kettlebell Windmill", muscleGroup: "Core", splits: "CORE" },
  { name: "Kettlebell Push Press", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  ...
  // Specialty bars
  { name: "Swiss Bar Bench Press", muscleGroup: "Chest", splits: "PUSH,UPPER" },
  { name: "Swiss Bar Floor Press", muscleGroup: "Chest", splits: "PUSH,UPPER" },
  { name: "Swiss Bar Overhead Press", muscleGroup: "Shoulders", splits: "PUSH,UPPER" },
  { name: "Swiss Bar Row", muscleGroup: "Back", splits: "PULL,UPPER" },
  { name: "Cambered Bar Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Football Bar Bench Press", muscleGroup: "Chest", splits: "PUSH,UPPER" },
  { name: "Hatfield Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },

  // Strongman / odd objects
  { name: "Atlas Stone Lift", muscleGroup: "Back", splits: "PULL,FULL_BODY" },
  ...
  { name: "Spider-Man Push-Up", muscleGroup: "Chest", splits: "PUSH,FULL_BODY" },
  { name: "Plyometric Push-Up", muscleGroup: "Chest", splits: "PUSH" },
  { name: "Wall Sit", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Hindu Squat", muscleGroup: "Quads", splits: "LEGS,LOWER" },

  // Plyometric / explosive
  { name: "Tuck Jump", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Depth Jump", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Hurdle Jump", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Skater Jump", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Lateral Bound", muscleGroup: "Quads", splits: "LEGS,LOWER" },
  { name: "Single-Leg Box Jump", muscleGroup: "Quads", splits: "LEGS,LOWER" },

  // Glute / hip accessory (banded)
  { name: "Banded Glute Bridge", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Banded Lateral Walk", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Monster Walk", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Clamshell", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Fire Hydrant", muscleGroup: "Glutes", splits: "LEGS,LOWER" },
  { name: "Frog Pump", muscleGroup: "Glutes", splits: "LEGS,LOWER" },

  // Core additions
  { name: "Bicycle Crunch", muscleGroup: "Core", splits: "CORE" },
  { name: "V-Up", muscleGroup: "Core", splits: "CORE" },
  { name: "Toe Touch", muscleGroup: "Core", splits: "CORE" },
  { name: "Reverse Crunch", muscleGroup: "Core", splits: "CORE" },
  { name: "Flutter Kicks", muscleGroup: "Core", splits: "CORE" },
  { name: "Scissor Kicks", muscleGroup: "Core", splits: "CORE" },
  { name: "Lying Leg Raise", muscleGroup: "Core", splits: "CORE" },
  { name: "Bird Dog", muscleGroup: "Core", splits: "CORE" },
  { name: "Bench Knee Tuck", muscleGroup: "Core", splits: "CORE" },
  { name: "Side Bend (Dumbbell)", muscleGroup: "Core", splits: "CORE" },
  { name: "Hanging Pike", muscleGroup: "Core", splits: "CORE" },

  // Forearms / grip additions
  { name: "Wrist Roller", muscleGroup: "Forearms", splits: "ARMS" },
  { name: "Towel Pull-Up", muscleGroup: "Forearms", splits: "PULL,ARMS" },
  { name: "Dead Hang (sec)", muscleGroup: "Forearms", splits: "PULL,ARMS" },
  { name: "Captain of Crush Hold", muscleGroup: "Forearms", splits: "ARMS" },
  { name: "Plate Wrist Curl", muscleGroup: "Forearms", splits: "ARMS,UPPER,PULL" },
...
export const WORKOUT_TYPES: {
  ...
  { value: "ELLIPTICAL", label: "Elliptical", shape: "DISTANCE" },
  { value: "STAIR_CLIMBER", label: "Stair climber", shape: "DURATION" },
  { value: "SWIMMING", label: "Swimming", shape: "DISTANCE" },
  { value: "ROWING", label: "Rowing", shape: "DISTANCE" },
  { value: "CARDIO_MACHINE", label: "Other cardio machine", shape: "DURATION" },
