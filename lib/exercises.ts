...
export const DEFAULT_EXERCISES: DefaultExercise[] = [
  ...
  { name: "Hindu Squat", muscleGroup: "Quads", splits: "LEGS" },

  // Plyometric / explosive
  { name: "Tuck Jump", muscleGroup: "Quads", splits: "LEGS" },
  { name: "Depth Jump", muscleGroup: "Quads", splits: "LEGS" },
  { name: "Hurdle Jump", muscleGroup: "Quads", splits: "LEGS" },
  { name: "Skater Jump", muscleGroup: "Quads", splits: "LEGS" },
  { name: "Lateral Bound", muscleGroup: "Quads", splits: "LEGS" },
  { name: "Single-Leg Box Jump", muscleGroup: "Quads", splits: "LEGS" },
