...
- Single-sleeve plate-loaded movements (chest-supported T-bar row, landmine T-bar row) load plates on ONE end only — there is no "per side." "T-bar row 2 plates for 8" → weight="90" (2 × 45), reps="8". Do NOT double the count.
